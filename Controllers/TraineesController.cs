...
namespace AssigmentCode.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProgrammingLanguage,TOEIC,Id,Username,Email,Password")] Trainee trainee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProgrammingLanguage,TOEIC,Id,Username,Email,Password")] Trainee trainee)
        {
            if (id != trainee.Id)
            {
                return NotFound();
